...
select lives_ok(
    format($f$ insert into escala_semanal (semana_ref, usuario_id, turno) values ('2026-07-30', %L, 'H3') $f$, :'kilson_id'),
    'OPERADOR_H3 ativo pode ser escalado para H3'
);

select throws_ok(
    format($f$ insert into escala_semanal (semana_ref, usuario_id, turno) values ('2026-07-30', %L, 'H3') $f$, :'leonardo_id'),
    'P0001',
...
select lives_ok(
    format($f$ insert into escala_semanal (semana_ref, usuario_id, turno) values ('2026-07-30', %L, 'H1') $f$, :'leonardo_id'),
